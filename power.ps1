...
$smtp.Credentials = New-Object System.Net.NetworkCredential("fsd83024@gmail.com", "Waleedawad2121");
$smtp.EnableSsl = $true
$Message.From = "fsd83024@gmail.com"
$Message.To.Add("fsd83024@gmail.com")
